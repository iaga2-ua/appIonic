...
export class ArticlePage implements OnInit {
  ...
  constructor(private srv: WikiService, private route: ActivatedRoute, private srvStorage: StorageService, private toastController: ToastController) { }
  ...
  toggleFavorite() {
    ...
    if (this.isFavorite) {
      ...
      this.srvStorage.set('favorites', this.favorites);
